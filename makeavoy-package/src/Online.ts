...
//       socket.emit("joined");
//       if (pendingLogin) pendingLogin.remove();
...
//           "You now have " + guests.length + " guests!",
//           options
//         );
//       }
//       if (conversation && conversation.length) Chat.lastChats(conversation);
